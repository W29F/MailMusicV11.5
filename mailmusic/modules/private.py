...
from mailmusic.config import BOT_USERNAME, PROJECT_NAME, SUPPORT_GROUP, UPDATES_CHANNEL
from mailmusic.modules.msg import Messages as tr
    ...
    client.send_message(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "News Update", url=f"https://t.me/{UPDATES_CHANNEL}"
                    ),
