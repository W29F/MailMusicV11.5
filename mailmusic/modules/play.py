...
from mailmusic.config import DURATION_LIMIT, que
from mailmusic.config import mailmusic_IMG
...
from mailmusic.services.callsmusic import callsmusic, queues
from mailmusic.services.callsmusic.callsmusic import client as USER
from mailmusic.services.converter.converter import convert
from mailmusic.services.downloaders import youtube
...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    ImageDraw.Draw(img)
    ImageFont.truetype("etc/font.otf", 32)
...
async def play(_, message: Message):
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    # print(e)
                    await lel.edit(
                        f"<b>Flood Wait Error \nUser {user.first_name} couldn't join your group due to heavy requests for userbot! Make sure user is not banned in group</b>",
                    )
    try:
    ...
    if audio:
        ...
        try:
            ...
            thumb_name = f"thumb{title}mailmusic.jpg"
            ...
            [
                ...
                [
                    InlineKeyboardButton(
                        text="News Update", url="https://t.me/mailmusicupdate"
                    ),
                ],
                [InlineKeyboardButton(text="Close", callback_data="cls")],
            ]
